...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li class="active">Thêm Hỏi đáp</li>
    </ol>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thêm Hỏi đáp</h4>
                        <p>Bạn cần nhập đầy đủ các thông tin để thêm Hỏi đáp mới</p>
                    </div>
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <input class="form-control"
                                   ...
                                   type="text"
                                   value="{{old('name')}}"
                                   placeholder="Tiêu đề hỏi đáp">
                        </div>

                        <div class="form-group">
                            <label>Nội dung hỏi đáp</label>
                            <textarea id="editor1" name="description" class="form-control makeMeRichTextarea" rows="3"
                                      placeholder="Nội dung sản phẩm">{{old('description')}}</textarea>
                        </div>
            ...
            <div class="col-sm-4">
                <div class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            <label>Trạng thái ( Cho phép hiển thị hoặc tạm ẩn)</label>
