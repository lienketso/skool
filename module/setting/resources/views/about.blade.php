...
@section('content')
    ...
    <ol class="breadcrumb breadcrumb-quirk">
        ...
        <li><a href="{{route('wadmin::setting.index.get')}}">Thông tin hỗ trợ</a></li>
            ...
            <div class="col-sm-8">
                <div class="panel">
                    <div class="panel-heading">
                        <h4 class="panel-title">Thông tin hỗ trợ trang chủ</h4>
                    ...
                    <div class="panel-body">
                      ...
                      <!--       <div class="list_about_section_1">
                        ...
                        <div class="info_ss_list">
                            ...
                            <div class="form-group">
                                <label>Mô tả box 2</label>
                                <textarea id="" name="about_section_2_desc_{{$language}}" class="form-control" rows="3"
                                          placeholder="Mô tả website">{{$setting->getSettingMeta('about_section_2_desc_'.$language)}}</textarea>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="info_ss_list">
                         ...
                         <div class="info_ss_list">
                            <h3>Thông tin box 4</h3>
                            <div class="form-group">
                                <label>Tiêu đề box 4</label>
                                <input class="form-control"
                                       name="about_section_4_title_{{$language}}"
                                       type="text"
                                       value="{{$setting->getSettingMeta('about_section_4_title_'.$language)}}"
                                       placeholder="Tiêu đề section 4">
                            </div>

                            <div class="form-group">
                                <label>Ảnh đại diện</label>
                                <div class="input-group col-xs-12" style="display: flex">
                                    <input type="text" name="about_section_4_img" value="{{$setting->getSettingMeta('about_section_4_img')}}"
                                ...
                                <div class="thumbnail_w" style="padding-top: 10px">
                                    <img src="{{ ($setting->getSettingMeta('about_section_4_img')!='null') ? upload_url($setting->getSettingMeta('about_section_4_img')) :  public_url('admin/themes/images/no-image.png')}}" width="100" alt="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label>Mô tả</label>
                                <textarea id="" name="about_section_4_desc_{{$language}}" class="form-control" rows="3"
                                          placeholder="Mô tả ngắn">{{$setting->getSettingMeta('about_section_4_desc_'.$language)}}</textarea>
                            </div>
